...
/**
 * name:org.learn2pro.codeplayground.rpc.core.CodecRegistry author:tderong date:2020/6/25
 */
public class CodecRegistry {
   ...
   * @return
   */
  public static CodecProcessor<? extends RpcSerModel> getInstance(CodecType type,
      Class<? extends RpcSerModel> klazz) {
